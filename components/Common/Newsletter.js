                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-5">
                            <div className="newsletter-wrap">
                                <h2>Încearcă acum gratui</h2>

                                <form className="newsletter-form">
                                    <input type="email" className="form-control" placeholder="Email-ul tău" name="email" required />
                        ...
                        <div className="col-lg-5">
                            <div className="call-us">
                                <h2>Primește informații superioare gratuit</h2>
